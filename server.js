...
const BACKEND_HOST = process.env.BACKEND_HOST || 'http://52.73.222.252:8000';
const BACKEND_ENDPOINTS = {
    '/upload/proposalform/pdf': `${BACKEND_HOST}/upload/proposalform/pdf`,
...
app.post('/upload/proposalform/pdf', requireAuth, upload.single('file'), handleFileUpload);
